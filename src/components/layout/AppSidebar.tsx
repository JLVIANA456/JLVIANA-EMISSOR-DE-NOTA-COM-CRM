...
const navigation = [
  ...
  {
    label: "Portal do Cliente BPO",
    items: [
      { name: "Gestão de Clientes", href: "/pessoas", icon: Users },
      { name: "Faturamento & Recibos", href: "/folha-pagamento", icon: Receipt },
      { name: "Portal do Cliente", href: "/portal-pj", icon: ExternalLink },
    ],
  },
];
