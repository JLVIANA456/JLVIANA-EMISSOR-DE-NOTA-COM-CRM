    ...
    <header className="h-24 bg-white/80 backdrop-blur-xl border-b border-slate-200/60 flex items-center justify-between px-8 sticky top-0 z-50">
      <div className="flex items-center gap-8 flex-1">
        <div className="relative group hidden lg:block">
          ...
          <input
            ...
            className="w-72 pl-11 pr-4 py-2.5 bg-slate-100/50 border border-transparent rounded-2xl text-sm outline-none focus:bg-white focus:border-slate-200 focus:ring-4 focus:ring-slate-500/5 transition-all"
          />
        </div>
        ...
        {fileName && (
          <div className="flex items-center gap-3 text-xs text-slate-700 font-extrabold px-5 py-2.5 bg-slate-100 rounded-2xl border border-slate-200 animate-in zoom-in-95 duration-300">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className={`relative group flex items-center gap-3 px-8 py-3.5 rounded-2xl text-sm font-bold transition-all duration-300 active:scale-95 ${isProcessing || !isReadyToUpload
