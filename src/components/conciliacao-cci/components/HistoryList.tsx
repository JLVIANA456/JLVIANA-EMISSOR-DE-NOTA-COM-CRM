    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-[1400px] mx-auto">
        ...
        <div className="p-6 border-b border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="relative flex-1 w-full max-w-md">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-transparent rounded-2xl text-sm outline-none focus:bg-white focus:border-slate-200 transition-all"
            />
          </div>
      ...
      <div className="bg-white p-8 rounded-[40px] text-slate-900 border border-slate-200 shadow-xl shadow-slate-100/50 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative">
        ...
        <div className="flex items-center gap-4 relative z-10">
          <div className="w-14 h-14 bg-slate-100 rounded-2xl flex items-center justify-center border border-slate-200 shadow-sm text-slate-400">
            <FileCheck className="w-7 h-7" />
          </div>
          <div>
            <h4 className="font-bold text-lg text-slate-900">Pronto para mais?</h4>
            <p className="text-slate-500 text-sm opacity-80">O CCI já otimizou o processamento de {history.length} lotes.</p>
          </div>
        </div>
        <button
          onClick={onNewBatch}
          className="flex items-center gap-2 px-8 py-4 bg-slate-900 text-white rounded-2xl font-black text-sm shadow-xl shadow-slate-200 hover:bg-black transition-all active:scale-95 relative z-10"
        >
