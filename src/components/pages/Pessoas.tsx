    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-light tracking-tight">Gestão de Clientes BPO</h1>
            <p className="text-sm text-muted-foreground">Relacionamento, contratos de serviço e solicitações do cliente</p>
          </div>
        </div>
        ...
        <>
          ...
          <Tabs defaultValue="tabela" className="space-y-4">
            <TabsList className="flex-wrap">
              <TabsTrigger value="tabela">Meus Clientes</TabsTrigger>
              <TabsTrigger value="contratos">Contratos de Serviço</TabsTrigger>
              ...
              <TabsTrigger value="dashboard-dp">Dashboard Carteira</TabsTrigger>
              <TabsTrigger value="impacto">Análise de Receita</TabsTrigger>
