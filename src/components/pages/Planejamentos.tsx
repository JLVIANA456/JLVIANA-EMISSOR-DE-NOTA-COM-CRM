    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] text-center p-6 space-y-6 animate-in fade-in duration-700">
            ...
            <div className="space-y-3 max-w-md">
                ...
                <h1 className="text-4xl font-light tracking-tight text-foreground/90">Planejamentos & Metas</h1>
                <p className="text-sm text-muted-foreground font-light leading-relaxed">
                    Estamos reformulando este módulo para incluir previsões baseadas em IA.
